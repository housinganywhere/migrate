...
For a detailed example see: [sample_mongodb_migrator.go](https://github.com/housinganywhere/migrate/blob/master/driver/mongodb/example/sample_mongdb_migrator.go)

```go
package my_mongo_db_migrator

import (
  "github.com/housinganywhere/migrate/driver/mongodb"
